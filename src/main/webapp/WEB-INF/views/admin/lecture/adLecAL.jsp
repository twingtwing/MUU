					...
					<div class="card-body">
						...
						<div class="row position-relative">
							<table class="admin_search table table-bordered">
								<tr height="38">
									...
									<th width="15%">강의명</th>
									<td width="35%"><input class="w-100 border" type="text"
										spellcheck="false"></td>
								</tr>
								<tr>
									<th>카테고리</th>
									...
									<td class="text-left"><input type="checkbox" class="ml-2"
										name="" id="complete" spellcheck="false"> <label
										for="complete" class="mr-3 mb-0">등록완료</label> <input
										type="checkbox" name="" id="waiting" spellcheck="false">
										<label for="waiting" class="mb-0 mr-3">대기중</label></td>
								</tr>
								<tr height="38">
									<th>등록 신청 날짜</th>
									<td colspan="3">
										<div class="d-flex border-0 align-items-center">
											<input type="date" class="border w-30"> <i
												class="fas fa-minus mx-2"></i> <input type="date"
												class="border w-30">
										</div>
									</td>
								</tr>
						...
						<div class="row">
							<table class="table table-bordered">
								...
								<tr>
									<td>4</td>
									<td><span>요리</span> > <span>베이킹</span></td>
							...
							<div class="dataTables_paginate paging_simple_numbers"
								...
								<ul class="pagination">
									<li class="paginate_button page-item previous"
										...
										class="page-link"><i class="mdi mdi-chevron-double-left"></i></a></li>
